...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'p-input-text': 'h-48px text-center leading-32px py-8px b-#5C33BE b-1 focus:shadow focus:shadow-inset rounded-8px text-18px',
    'p-form': 'px-16px flex flex-col gap-y-24px children-flex children-flex-col',
