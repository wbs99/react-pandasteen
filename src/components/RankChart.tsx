  ...
  const renderItems = () => {
    return (
      dataSource?.map((item, index) =>
        <div key={item.name} className='grid grid-cols-[48px_1fr_1fr] grid-rows-2 text-xs items-center gap-y-[6px] gap-x-2 px-4 my-2'>
          ...
          <div className='row-start-2 col-start-2 row-end-3 col-end-4 h-2 self-start rounded overflow-hidden bg-[#cccccc] relative'>
